...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)
            ...
            [SubPop1, Fitness1] = EnvironmentalSelectionSOP(P, N1, alphaSet(1,:), min(P.objs, [], 1)); % Store solutions with low selected feature ratio
            [SubPop2, Fitness2] = EnvironmentalSelectionSOP(P, N2, alphaSet(2,:), min(P.objs, [], 1)); % Store solutions with better classification performance          
            ...
            while Algorithm.NotTerminated(Population)
                ...
                Offspring      = OffspringReproduction(Population(MatingPool), [Population, SubPop1, SubPop2]);
                % Offspring generation for single-objective task I
                MatingPoolPop1 = TournamentSelection(2, N1, Fitness1);
                OffPop1        = OffspringReproduction(SubPop1(MatingPoolPop1), [Population, SubPop1, SubPop2, Offspring]);
                % Offspring generation for single-objective task II
                MatingPoolPop2 = TournamentSelection(2, N2, Fitness2);
                OffPop2        = OffspringReproduction(SubPop2(MatingPoolPop2), [Population, SubPop1, SubPop2, Offspring, OffPop1]);
...
function [SubPop1, Fitness1, SubPop2, Fitness2] = ReInitialization(Pop, N1, N2, alphaSet, Fmin)
